...
@section('content')
	...
	<div class="container" id="backPreview">
		...
		<section id="section1" @if(isset($data) && count($data) > 0) style="background-image: url('/storage/{{$data[0]->image_background_url}}') " @endif>
			@if(isset($data) && count($data) > 0) 
        		<img id="imgSecond" @if(isset($data) && count($data) > 0) src="/storage/{{$data[0]->image_second_url}}"> @endif 
    		@endif  
		</section>
		<section id="section2">
			<div class="container">
							...
							<div class="col-sm-3"> 
								<div class="card">
									<div class="card-title">
										<img src="/storage/{{$c->file_url}}" width="120" height="200">
									</div>
									<div class="card-body">
										{{$c->description}}
									</div>
